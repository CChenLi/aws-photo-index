...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://bt5xzzjy9g.execute-api.us-east-1.amazonaws.com/firststage';
    ...
    apigClient.chatbotPost = function (params, body, additionalParams) {
        ...
        /* console.log(body.messages[0].unstructured.text) */
        ...
        console.log("Reqeust: ", chatbotPostRequest)
